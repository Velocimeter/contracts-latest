...
//  forge script scripts/Vote.s.sol:Vote --rpc-url https://mainnode.plexnode.org:8545 -vvv
// forge script scripts/Vote.s.sol:Vote --rpc-url https://mainnode.plexnode.org:8545 -vvv --broadcast --slow

//  forge script scripts/Vote.s.sol:Vote --rpc-url https://canto.slingshot.finance	 -vvv
// forge script scripts/Vote.s.sol:Vote --rpc-url https://canto.slingshot.finance -vvv --broadcast --slow
...
contract Vote is Script { 
    ...
    function run() external {
        ...
        // voter.vote(2, FLOW_ATOM, ONEHUNDRED ); // 1M  
        // voter.vote(3, FLOW_USDT, ONEHUNDRED ); // 1M 
        // voter.vote(4, FLOW_multiBTC, ONEHUNDRED ); // 1M
        // voter.vote(5, FLOW_multiBTC, ONEHUNDRED ); // 1M
        // voter.vote(6, FLOW_ETH, ONEHUNDRED ); // 1M reset()
        // voter.vote(7, FLOW_USDC, ONEHUNDRED ); // 2M
        // voter.vote(8, FLOW_NOTE, ONEHUNDRED ); //  2M
        // voter.vote(9, FLOW_WCANTO, ONEHUNDRED ); // 2M
        // voter.vote(10, FLOW_USDT, ONEHUNDRED ); //  2M
        // voter.vote(11, FLOW_ETH, ONEHUNDRED ); // 2M
        // voter.vote(12, FLOW_USDC, ONEHUNDRED ); // 2M
        // voter.vote(13, FLOW_NOTE, ONEHUNDRED ); //  3M
