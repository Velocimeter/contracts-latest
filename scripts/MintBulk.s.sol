...
address constant ser = 0x50230fbfC593C92E55ae27d3F25633DdB9693Ef6;

uint256 constant FOUR_YEARS = 126_144_000;
uint256 constant TWOHUNDREDK = 200_000 * 1e18;
...
contract MintBulk is Script {
    ...
    votingEscrow.create_lock_for(TWOHUNDREDK,FOUR_YEARS,ser);
    votingEscrow.create_lock_for(TWOHUNDREDK,FOUR_YEARS,ser);
    votingEscrow.create_lock_for(TWOHUNDREDK,FOUR_YEARS,ser);
    votingEscrow.create_lock_for(TWOHUNDREDK,FOUR_YEARS,ser);
    votingEscrow.create_lock_for(TWOHUNDREDK,FOUR_YEARS,ser);
